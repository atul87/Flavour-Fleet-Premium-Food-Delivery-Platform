...
def seed_menu_items():
    ...
    items = [
        # ── Pizza ──
        {'item_id': 'p1', 'name': 'Margherita Pizza', 'price': 299, 'category': 'pizza',
        ...
        # ── Mexican ──
        {'item_id': 'm1', 'name': 'Street Tacos', 'price': 199, 'category': 'mexican',
        ...
        {'item_id': 'sa2', 'name': 'Quinoa Power Bowl', 'price': 249, 'category': 'salad',
         'image': 'assets/images/salad.png', 'restaurant': 'Green Bowl Co.',
         'rating': 4.8, 'badge': 'Vegan', 'description': 'Quinoa, roasted veggies, avocado, tahini lemon dressing'},

        # ── Chinese ──
        {'item_id': 'c1', 'name': 'Kung Pao Chicken', 'price': 349, 'category': 'chinese',
        ...
        {'item_id': 'c2', 'name': 'Dim Sum Platter', 'price': 399, 'category': 'chinese',
         'image': 'assets/images/chinese.png', 'restaurant': 'Golden Dragon',
         'rating': 4.7, 'badge': 'Popular', 'description': 'Assorted steamed dumplings — har gow, siu mai, char siu bao'},
        {'item_id': 'c3', 'name': 'Vegetable Chow Mein', 'price': 199, 'category': 'chinese',
        ...
        # ── Dessert ──
        {'item_id': 'd1', 'name': 'Chocolate Lava Cake', 'price': 149, 'category': 'dessert',
...
def seed_offers():
    ...
    offers = [
        ...
        {'code': 'FREEDEL', 'title': 'Free Delivery All Week', 'description': 'No delivery fee on orders above ₹299. Save your money for more food!',
         'discount_type': 'delivery', 'discount_value': 49, 'icon': '🚚', 'color': 'teal',
        ...
        {'code': 'FAMILY10', 'title': 'Family Feast', 'description': 'Flat ₹200 off on family-sized orders above ₹799. Feed the whole gang for less!',
         'discount_type': 'flat', 'discount_value': 200, 'icon': '👨‍👩‍👧‍👦', 'color': 'gold',
        ...
        {'code': 'BREKKY99', 'title': 'Breakfast Combo', 'description': 'Any breakfast item + coffee for just ₹99. Available 7 AM – 11 AM daily.',
         'discount_type': 'flat', 'discount_value': 100, 'icon': '☕', 'color': 'orange',
         'valid_till': '7AM – 11AM', 'tag': ''},
        {'code': 'ONLINE15', 'title': 'Pay Online & Save', 'description': 'Extra 15% off (up to ₹150) when you pay via UPI, cards, or wallet.',
         'discount_type': 'percent', 'discount_value': 15, 'icon': '💳', 'color': 'teal',
         'valid_till': 'All payment modes', 'tag': ''},
        {'code': 'BDAY2026', 'title': 'Birthday Surprise', 'description': "It's your birthday? Get a free chocolate lava cake with any order over ₹499!",
         'discount_type': 'flat', 'discount_value': 149, 'icon': '🎂', 'color': 'purple',
         'valid_till': 'Your B-day month', 'tag': ''},
        {'code': 'FIRST50', 'title': '50% Off First Order', 'description': 'New to Flavour Fleet? Enjoy a massive 50% discount on your first order (up to ₹599).',
        ...
        {'code': 'WELCOME10', 'title': 'Welcome 10% Off', 'description': '10% off your first order. No minimum order required.',
         ...
         'valid_till': 'No expiry', 'tag': ''},
        {'code': 'SAVE5', 'title': '₹100 Off Any Order', 'description': 'Flat ₹100 off on any order. No minimum required.',
         'discount_type': 'flat', 'discount_value': 100, 'icon': '💰', 'color': 'gold',
         'valid_till': 'No expiry', 'tag': ''},
        {'code': 'LUNCH99', 'title': 'Lunch Combo Deal', 'description': 'Any main + drink + dessert at just ₹99. 11AM–3PM only.',
         'discount_type': 'flat', 'discount_value': 150, 'icon': '🍱', 'color': 'orange',
